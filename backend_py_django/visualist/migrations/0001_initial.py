# -*- coding: utf-8 -*-
# Generated by Django 1.10.3 on 2017-01-24 04:29
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('record_type', models.CharField(choices=[('PERSON', 'person'), ('ORGANIZATION', 'organization')], default='PERSON', max_length=20)),
                ('first_name', models.CharField(blank=True, max_length=100)),
                ('organization_types', models.CharField(choices=[('ARCHIVE', 'archive'), ('ASSOCIATION', 'association'), ('COMPANY', 'company'), ('ENSEMBLE', 'ensemble'), ('FOUNDATION', 'foundation'), ('GALLERY', 'gallery'), ('LIBRARY', 'library'), ('MUSEUM', 'museum'), ('SCHOOL', 'school')], default='PERSON', max_length=20)),
            ],
            options={
                'abstract': False,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=250, unique=True)),
                ('description', models.TextField(blank=True)),
                ('record_type', models.CharField(choices=[('EXHIBITION', 'exhibition'), ('PERFORMANCE', 'performance'), ('WORKSHOP', 'workshop')], default='EXHIBITION', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=250, unique=True)),
                ('description', models.TextField(blank=True)),
                ('record_type', models.CharField(choices=[('VENUE', 'venue')], default='VENUE', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('slug', models.CharField(max_length=250, unique=True)),
                ('description', models.TextField(blank=True)),
                ('record_type', models.CharField(choices=[('MATERIAL', 'material works, e.g. painting, sculpture'), ('TEMPORAL', 'temporal works, e.g. a performance')], default='MATERIAL', max_length=20)),
            ],
            options={
                'abstract': False,
            },

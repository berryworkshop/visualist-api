# -*- coding: utf-8 -*-
# Generated by Django 1.11.5 on 2017-09-26 04:57
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('license', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='records_licensed', to='api.License')),
            ],
            options={
                'ordering': ['-created_on'],
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value', models.CharField(max_length=250)),
                ('source', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='api.Resource')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',

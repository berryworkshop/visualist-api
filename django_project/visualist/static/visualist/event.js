	...
	(function (global, factory) {
	  ...
	  */
	  ...
	  function Tag$$1(impl, conf, innerHTML) {
	    ...
	    defineProperty(this, 'mount', function tagMount() {
	      ...
	      if (this._parent && isAnonymous) {
	        inheritFrom.apply(this, [this._parent, propsInSyncWithParent]);
	      }
	  ...
	  function cleanUpData(data) {
	    if (!(data instanceof Tag$$1) && !(data && _typeof(data.trigger) === T_FUNCTION)) {
	      return data;
	    }
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('controls', '<h3>Controls</h3> <ul> <li>New</li> <li>Edit</li> <li>Delete</li> <li>Map it</li> <li>Featured</li> <li>Bookmark</li> <li>Add to Bucket List</li> <li> <h4>Cite</h4> <ul> <li>APA</li> <li>Chicago</li> <li>MLA</li> </ul> </li> <li> <h4>Permissions</h4> <ul> <li>Public</li> <li>Private</li> </ul> </li> <li> <h4>Share</h4> <ul> <li>Email</li> <li>Facebook</li> <li>Pinterest</li> </ul> </li> <li> <h4>Add to List</h4> <ul> <li>Checklist</li> <li>Bookmarks</li> </ul> </li> </ul>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('mini_tile', '<img src="https://placebear.com/g/100/100.jpg"> <p>This is a bear.</p>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('related_items', '<ul> <h3>{opts.title}</h3> <ul> <li>Related Item</li> <li>Related Item</li> <li>Related Item</li> </ul> </ul>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('source', '<dl> <dd>Source</dd> <dt>The Art Institute of Chicago</dt> <dd>Format</dd> <dt>Website</dt> <dd>Accessed</dd> <dt>January 1, 2017</dt> <dd>Rights</dd> <dt>Public Domain</dt> </dl>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16)))
...
/***/ function(module, exports, __webpack_require__) {
	...
	riot.tag2('cross_refs', '<ul> <h3>Cross References</h3> <li>Getty</li> <li>Art Institute of Chicago</li> <li>Library of Congress</li> <li>Artnet</li> <li>Chicago Gallery News</li> </ul>', '', '', function (opts) {});
	/* WEBPACK VAR INJECTION */}.call(exports, __webpack_require__(16)))
